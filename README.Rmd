...
[![Github Closed Issues](https://img.shields.io/github/issues-closed-raw/phylotastic/datelife.svg)](https://github.com/phylotastic/OpenTreeChronograms/issues?q=is%3Aissue+is%3Aclosed)
...
`OpenTreeChronograms` is an R package that is intended to work along the 
...
For example, to install `version 2022.06.13`, you can run:
